...
```{r}
model <- lm(Price ~ Age + Engine.volume + Mileage + Manufacturer + Category + Leather.interior + Fuel.type + Gear.box.type + Drive.wheels + Wheel + Color + Airbags, data = car_data_clean)
```
